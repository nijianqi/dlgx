            ...
            if($topic){
                ...
                if(request()->file()){
                    ...
                    foreach($album as $key=>$val){
                        ...
                        $topComAlbumModel->insertGetId(array('comment_id'=>$return,'album_img'=>$album_img.'?imageMogr2/quality/100/size-limit/100k/interlace/1','create_time'=>time()));
                    }
                }
            }else{
       ...
       if (request()->isPost()) {
            ...
            if(request()->file()){
               ...
               foreach($album as $key=>$val){
                   ...
                   $topAlbumModel->insertGetId(array('topic_id'=>$topic_id,'album_img'=>$album_img.'?imageMogr2/quality/100/size-limit/100k/interlace/1','create_time'=>time()));
               }
           }
           $topicLikeModel = new TopicLikeModel();
           $topicCollectModel = new TopicCollectModel();
