            ...
            if($activity) {
                ...
                if (request()->file()) {
                    ...
                    foreach ($album as $key => $val) {
                        ...
                        $actComAlbumModel->insertGetId(array('comment_id' => $return, 'album_img' => $album_img.'?imageMogr2/quality/100!/size-limit/300k/interlace/1', 'create_time' => time()));
                    }
                }
            }else{
        ...
        if (request()->isPost()) {
            ...
            if(request()->file()){
                ...
                foreach($album as $key=>$val){
                    ...
                    $activityAlbumModel->insertGetId(array('act_id'=>0,'act_name'=>$param['act_name'],'album_img'=>$album_img.'?imageMogr2/quality/100!/size-limit/300k/interlace/1','create_time'=>time()));
