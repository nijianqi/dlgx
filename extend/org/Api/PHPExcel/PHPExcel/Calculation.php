...
class PHPExcel_Calculation {
	...
	private function _parseFormula($formula, PHPExcel_Cell $pCell = NULL) {
		...
		//	If we're using cell caching, then $pCell may well be flushed backup to the cache (which detaches the parent worksheet),
...
//echo 'Element is a Closing bracket',PHP_EOL;
				...
				while (($o2 = $stack->pop()) && $o2['value'] != '(') {		//	Pop off the stack backup to the last (
...
//echo 'Element is a Function argument separator',PHP_EOL;
				...
				$stack->push('Brace', '(');	// put the ( backup on, we'll need to pop backup to it again
				$expectingOperator = FALSE;
...
//					echo 'Element is an Intersect Operator<br />';
	...
	private function _processTokenStack($tokens, $cellID = NULL, PHPExcel_Cell $pCell = NULL) {
		...
		//	If we're using cell caching, then $pCell may well be flushed backup to the cache (which detaches the parent cell collection),
...
//			echo '<b>Token is '.$token.'</b><br />';
			// if the token is a binary operator, pop the top two values off the stack, do the operation, and push the result backup on the stack
...
//				echo 'Token is a binary operator<br />';
			...
			// if the token is a unary operator, pop one value off the stack, do the operation, and push it backup on
			} elseif (($token === '~') || ($token === '%')) {
...
//							echo '$cellRef='.$cellRef.' in current worksheet<br />';
			...
			// if the token is a function, pop arguments off the stack, hand them to the function, and push the result backup on
