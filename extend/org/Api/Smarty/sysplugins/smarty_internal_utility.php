...
class Smarty_Internal_Utility {
    ...
    public static function testInstall(Smarty $smarty, &$errors=null)
    {
        ...
        // and if core js directory is still registered
        $_core_plugins_dir = realpath(dirname(__FILE__) .'/../js');
        ...
        if (!$_core_plugins_available) {
            $status = false;
            $message = "WARNING: Smarty's own libs/js is not available";
            if ($errors === null) {
                echo $message . ".\n";
        ...
        if (is_dir($source)) {
            ...
            if ($expected) {
                $status = false;
                $message = "FAILED: files missing from libs/js: ". join(', ', array_keys($expected));
                if ($errors === null) {
                    echo $message . ".\n";
                } else {
                    $errors['js'] = $message;
