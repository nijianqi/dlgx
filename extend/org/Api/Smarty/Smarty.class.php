...
/**
* set SMARTY_SYSPLUGINS_DIR to absolute path to Smarty internal js.
...
if (!defined('SMARTY_PLUGINS_DIR')) {
    define('SMARTY_PLUGINS_DIR', SMARTY_DIR . 'js' . DS);
}
...
class Smarty extends Smarty_Internal_TemplateBase {
    ...
    * Set js directory
    *
    * @param string|array $plugins_dir directory(s) of js
    * @return Smarty current Smarty instance for chaining
    */
