...
class OssClientObjectTest extends TestOssClientBase
{
    ...
    {
        $object = "oss-qiniu-test/upload-test-object-name.txt";
        try {
    ...
    public function testObject()
    {
        ...
        $from_object = "oss-qiniu-test/upload-test-object-name.txt";
         ...
         *  删除多个个文件
         */
        $object1 = "oss-qiniu-test/upload-test-object-name.txt";
        $object2 = "oss-qiniu-test/upload-test-object-name.txt.copy";
    ...
    {
        parent::setUp();
        $this->ossClient->putObject($this->bucket, 'oss-qiniu-test/upload-test-object-name.txt', file_get_contents(__FILE__));
    }
}
