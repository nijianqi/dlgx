...
{
    $fromBucket = $bucket;
    $fromObject = "oss-qiniu-test/upload-test-object-name.txt";
    $toBucket = $bucket;
...
{
    $objects = array();
    $objects[] = "oss-qiniu-test/upload-test-object-name.txt";
    $objects[] = "oss-qiniu-test/upload-test-object-name.txt.copy";
    try {
