...
class SMTP
{
    ...
    public function connect($host, $port = null, $timeout = 30, $options = array())
    {
        ...
        if ($streamok) {
            ...
            //Fall backup to fsockopen which should work in more places, but is missing some features
            $this->edebug(
                "Connection: stream_socket_client not available, falling backup to fsockopen",
                self::DEBUG_CONNECTION
            );
    ...
    protected function sendCommand($command, $commandstring, $expect)
    {
        ...
        if (preg_match("/^([0-9]{3})[ -](?:([0-9]\\.[0-9]\\.[0-9]) )?/", $this->last_reply, $matches)) {
            ...
            // Fall backup to simple parsing if regex fails
